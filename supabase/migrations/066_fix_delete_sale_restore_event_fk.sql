-- Migration: 066_fix_delete_sale_restore_event_fk
-- Evita que delete_sale_and_restore_stock inserte stock_events.sale_id
-- apuntando a una venta que ya fue borrada en la misma transaccion.
